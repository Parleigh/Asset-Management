            ...
            <?php
						if (mysqli_num_rows($result)){
							...
							<tr >
								...
								<td>
									<button class="btn btn-success btnActivate" style="background-color:green" type="submit" id="<?php echo $row['id']; ?>" name="btnActivate"><i style="color:white"  class="fa fa-check"></i></button>
								</td>
