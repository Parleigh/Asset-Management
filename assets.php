				...
				<?php
					...
					if (!$conn) {
					 ...
					 $sql = "SELECT id, assetName,accDepreciation, accImpairments, condAssessment, cost, description, assetHierarchy, usefulLife, 
								valuationInfo, carryingValue, date, active, address, assetImage
							FROM asset
							WHERE active = 1";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <h4 class="text-primary m-0 fw-bold">All Assets  <button class="btn btn-primary d-block btn-user w-30" style="float: right; background-color:#934ae9" onclick="document.location='addAsset.php'">Add Asset</button></h4>
                        ...
                        <div class="card-body">
							...
							<a style=" background-color: #934ae9;
								  ...
								  text-align: center;
								  text-decoration: none;
								  display: inline-block;" class="toggle-vis" data-column="3">Depreciation</a> - 
								  ...
								  text-align: center;
								  text-decoration: none;
								  display: inline-block;" class="toggle-vis" data-column="4">Impairments</a> -
								  ...
								  text-align: center;
								  text-decoration: none;
								  display: inline-block;" class="toggle-vis" data-column="5">Assessment</a> -
								  ...
								  text-align: center;
								  text-decoration: none;
								  display: inline-block;" class="toggle-vis" data-column="11">C-Value</a>
								  ...
								  text-align: center;
								  text-decoration: none;
								  display: inline-block;" class="toggle-vis" data-column="12">Address</a>
								  ...
								  text-align: center;
								  text-decoration: none;
								  display: inline-block;" class="toggle-vis" data-column="13">Image</a><br><br>
						...
						if (mysqli_num_rows($result)){
							...
							<tr>
								...
								<td class="imageContainer"><img width="50px" src="<?php echo $row['assetImage']; ?>"></td>
								
								<td>
									<form action="editAsset.php" method="post">
										<input type="hidden" name="edt_id" id="edt_id" value="<?php echo $row['id']; ?>" >
										<button style="background-color:#934ae9" class="btn btn-info" type="submit" name="edit_btn"><i class="fa fa-edit" style="color:white"></i></button>
									</form>
								</td>
								
								<!--td>
									<form action="asset_process.php" method="post">
										<input type="hidden" name="dltAss_id" id="dltAss_id" value="<?php //echo $row['id']; ?>">
								...
								<td>
										...
										<button class="btn btn-danger delete_btn" style="background-color:red" type="submit" id="<?php echo $row['id']; ?>" name="delete_btn"><i class="fa fa-trash"></i></button>
